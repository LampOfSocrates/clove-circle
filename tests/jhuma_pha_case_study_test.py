...
case_study_path = Path(__file__).resolve().parents[1] / "case_studies" / "wrapper-pha-lca-tea.html"
...
assert 'src="../standalone/PHA-from-lignocellulose-lca-tea.html"' in case_study_html
assert 'href="../standalone/PHA-from-lignocellulose-lca-tea.html"' in case_study_html
