...
(function (global) {
  ...
  var DIMENSIONS = {
    ...
    price_energy:     { canonical: '$/GJ',       units: { '$/GJ': 1, '$/MWh': 1 / 3.6, '$/kWh': 1000 / 3.6, '$/MJ': 1000, '£/kWh': 1000 / 3.6, '$M/TJ': 1000, 'GBP/kWh': 1000 / 3.6, 'GBP/MWh': 1 / 3.6, 'GBP/GJ': 1 } },
    price_volume:     { canonical: '$/m³',       units: { '$/m³': 1, '$/m3': 1, '$/L': 1000 } },
    currency:         { canonical: '$M',         units: { '$M': 1, '$': 1e-6, '$k': 1e-3, '£M': 1, 'M$': 1, 'MM$': 1, 'MGBP': 1, 'GBP': 1e-6, '£': 1e-6, 'kGBP': 1e-3, '£k': 1e-3 } },
